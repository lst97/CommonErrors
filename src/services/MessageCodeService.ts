...
import { Config } from "../CommonErrors.config";
...
export class MessageCodeService {
  ...
  constructor() {
    ...
    this._path = Config.instance.messageCodeDefinitionsFilePath;
      ...
      if (e.code === "ENOENT") {
        ...
        try {
          const data = fs.readFileSync(
            "node_modules/@lst97/common-errors/lib/cjs/src/models/MessageCodes.json",
            "utf8",
          );
...
export function MessageCodeServiceInstance(): IMessageCodeService {
